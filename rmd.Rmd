...
*We were also interested in investigating disability-based disparities because two of our team members have recent experience doing research work related to disability. *

##Initial Questions 

##Data

*The CDC created the [Disability and Health Data System (DHDS)](https://www.cdc.gov/ncbddd/disabilityandhealth/dhds/index.html) to provide epidemiologists, researchers, and public health professionals with accessible data on demographics and health outcomes for adults with disabilities. The DHDS obtained and analyzed data from the 2016-2018 Behavioral Risk Factor Surveillance System (BRFSS) reports.*
